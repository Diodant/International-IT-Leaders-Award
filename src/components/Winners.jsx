...
const winnersData = {
  2021: [
    { category: 'IT-специалист года', name: 'Владимир Топозли', country: 'Украина', description: 'За выдающийся вклад в разработку и внедрение высоконагруженных систем для крупных корпоративных клиентов.' },
    { category: 'Лучший разработчик программного обеспечения', name: 'Тертичко Игорь', country: 'Украина', description: 'За создание инновационного программного обеспечения для автоматизации бизнес-процессов, используемого в различных отраслях.' },
